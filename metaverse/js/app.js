(() => {
    ...
    function initSliders() {
        if (document.querySelector(".our-latest-activity__slider")) new swiper_core_Swiper(".our-latest-activity__slider", {
            observer: true,
            observeParents: true,
            slidesPerView: 1.1,
            spaceBetween: 30,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const slides = document.querySelectorAll(".our-latest-activity__slide");
        slides.forEach((slide => {
            const video = slide.querySelector(".our-latest-activity__video");
            const playButton = slide.querySelector(".our-latest-activity__button-play");
            const videoContainer = slide.querySelector(".our-latest-activity__video-block");
